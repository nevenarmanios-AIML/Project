...
## Classifying Historical Eras of State of the Union Speeches
...
## Documentation
The notebook includes the cleaned dataset, chunked text data, TF-IDF features, model training, classification results, and confusion matrix plots. These outputs were used to evaluate the model and better understand which eras were easiest or hardest to separate.

## Conclusion
This project showed that machine learning can identify broad historical eras in presidential speeches with reasonable accuracy. The results suggest that presidential rhetoric changes over time in ways that can be captured by text analysis. If I continued this project, I would try other models, test different chunk sizes, and split the data by full speech instead of by chunk for a stricter evaluation.
